...
void ioopm_linked_list_append(ioopm_list_t *list, elem_t value, heap_t *h);

/// @brief Insert at the front of a linked list in O(1) time
/// @param list the linked list that will be prepended to
/// @param value the value to be prepended
void ioopm_linked_list_prepend(ioopm_list_t *list, elem_t value, heap_t *h);
...
void ioopm_linked_list_insert(ioopm_list_t *list, int index, elem_t value, heap_t *h);
