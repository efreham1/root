...
static void update_NO_buckets (ioopm_hash_table_t *ht, heap_t *h)
{
  ...
  ioopm_hash_table_t *new_ht = ioopm_hash_table_create_spec (ht->load_factor, new_capacity, ht->h_fnc,
                                                             ht->compare_equal_keys, ht->compare_equal_values,
                                                             ht->compare_lessthan_keys, h);
...
ioopm_hash_table_t *ioopm_hash_table_create (ioopm_hash_function hash_function, ioopm_eq_function compare_eq_key,
                                             ioopm_eq_function compare_eq_values, ioopm_lt_function compare_lt_keys,
                                             heap_t *h)
{
  return ioopm_hash_table_create_spec (0.75, 200, hash_function, compare_eq_key, compare_eq_values, compare_lt_keys,
                                       h);
}

ioopm_hash_table_t *ioopm_hash_table_create_spec (float load_factor, int capacity, ioopm_hash_function hash_function,
                                                  ioopm_eq_function compare_eq_key, ioopm_eq_function compare_eq_values,
                                                  ioopm_lt_function compare_lt_keys, heap_t *h)
{
...
ioopm_hash_table_t *
ioopm_hash_table_load_from_file (heap_t *h, FILE *f, ioopm_hash_function hash_function, ioopm_eq_function compare_eq_key,
                                 ioopm_eq_function compare_eq_values, ioopm_lt_function compare_lt_keys)
{
